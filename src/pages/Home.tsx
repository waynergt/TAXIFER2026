...
export default function Home() {
  return (
    <div className="relative min-h-screen flex items-center pt-32 pb-32 bg-navy-900 overflow-hidden animate-enter">
      ...
      {/* Fondo decorativo (Efecto moderno) */}
  ...
  {/* Usamos el color naranja/amarillo del diseño anterior para mantener la identidad */}
...
{/* AQUI AGREGAMOS LA CUENTA REGRESIVA */}
<div className="mt-4">
  ...
  <Countdown />
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12 text-gray-200">
